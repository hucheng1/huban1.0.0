...
//鼠标滚动后效果
    ...
    if ($("body").scrollTop() >= 220) {
        ...
        $('.header_nav_left>ul>li:first-child').css('background', "url(img/logo1.svg) no-repeat");
        $('.header_nav_left>ul>li:last-child').css('background', "url(img/menu_sprite.svg) 0 -248px no-repeat");
